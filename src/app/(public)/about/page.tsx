...
export const metadata = {
  title: "About Us - Colombo International Campus",
  description:
...
const articles = [
  ...
  },
  {
    ...
    description: [
      ...
      " For some, immediate employment may not be the goal; instead, they seek to continue their education, hone new skills, and remain connected to family and community. At Colombo International Campus, we have listened to these needs and crafted a solution that offers flexibility, access, and opportunity.\n",
    ],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    description: [
      "At Colombo International Campus, we foster a vibrant, inclusive, and stimulating educational environment that emphasizes innovation, collaboration, and global connectivity. Our students benefit from state-of-the-art facilities, interactive learning spaces, and access to cutting-edge technology. Our faculty comprises passionate educators and industry professionals who bring real-world expertise and innovative teaching methods to the classroom. We prioritize experiential learning, enabling students to apply theoretical knowledge to practical challenges, collaborate on projects, and cultivate critical thinking and leadership skills.\n",
    ],
  },
  {
    id: 8,
  ...
  },
  {
    ...
    description: [
      ...
      "Welcome to Colombo International Campus where learning, opportunity, and ambition come together to create lasting success. Here, your future begins, and together, we can change the world.",
    ],
  },
];
...
const segments = [
  {
    ...
    title: "Our Mission",
    description: [
      "Our Mission is to support and empower students with energetic and imaginative minds through world-class education, Knowledge creation, and empowering connections to develop highly qualified individuals for competitive positions within the corporate world, which in turn will contribute to both professional and organizational growth.",
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: [
      "Colombo International Campus is passionate about empowering students to unlock their full potential and shape their futures. Join our community of successful students who have realized their dreams of studying abroad. Use our portal to apply to your preferred universities or contact us to schedule a consultation with one of our experienced educational consultants and embark on an extraordinary educational journey with Colombo International Campus",
      "Feel free to explore our website and discover how Colombo International Campus can help shape your educational journey.",
    ],
  },
];
      ...
      <ContainerLayout>
        <div className="pt-12 pb-12">
          <div className="flex flex-col justify-center items-center relative bg-transparent w-full">
            <SectionHeader
              title="About Us"
              description="Welcome to Colombo International Campus."
            />
          </div>
        </div>
        <InnerContainer>
